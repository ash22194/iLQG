function ddc = ddcostdux(sys, x, u, sub_policies)
    %% Inputs
    ...
    R = sys.R(U_DIMS_FREE, U_DIMS_CONTROLLED) + sys.R(U_DIMS_CONTROLLED, U_DIMS_FREE)';
    ...
    ddc = zeros(length(U_DIMS_FREE), length(X_DIMS_FREE), TRAJ_LENGTH);
