function [unique_population, unique_population_id] = extract_unique_decompositions(sys, population)
    ...
    [unique_population, unique_population_id] = unique(population_, 'rows', 'stable');
end