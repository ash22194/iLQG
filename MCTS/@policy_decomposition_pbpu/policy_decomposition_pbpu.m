        ...
        function child = expand_best_child(de, determ, predictor)
            ...
            if ((de.childnode_maxcount > 0) ...
                ...
                if ((k < k_init) ...
                    ...
                    if ((num_childnodes_unexplored == 0) && (sum(de.childnodes_unexpanded)==0))
                        de.subtree_unexplored = false;
                        de.visit_count = de.visit_count - 1;
                        child = de.parent;
                        return;
                    ...
                    childnodes_to_explore_measure(childnodes_unexplored) ...
                        = cellfun(@(x) x.measure, de.childnodes(childnodes_unexplored));
                    childnodes_unexplored_max_measure = max([0; childnodes_to_explore_measure(childnodes_unexplored)]);
                    childnodes_to_explore_measure(de.childnodes_unexpanded) ...
                        = childnodes_unexplored_max_measure ...
                          + de.childnodes_measure_prediction(de.childnodes_unexpanded);

                    [~, childnodes_to_explore_order] = sort(childnodes_to_explore_measure);
                    try
                        childnodes_to_explore_order = childnodes_to_explore_order(1:min(de.childnode_maxcount, ...
                                                                                        max(k_init, k+1)));
                    catch
                        disp('blah');
                    end
                    ...
                    childnodes_unexpanded_unpruned = de.childnodes_unpruned & de.childnodes_unexpanded;
                    if any(childnodes_unexpanded_unpruned)
                        de.childnodes(childnodes_unexpanded_unpruned) ...
                          = cellfun(@(x) policy_decomposition_pbpu(de.sys, x, de), ...
                                    de.childnodes(childnodes_unexpanded_unpruned), ...
                                    'UniformOutput', false);
                        de.childnodes_unexpanded(childnodes_unexpanded_unpruned) = false;
                    end
                end
                ...
                measure_uct = -childnodes_to_consider_heuristic ...
                              ...
                              + sqrt(2 * log(max(de.visit_count, 2)) ./ childnodes_to_consider_visit_count);
