...
% matlabFunction(sys.f, 'File', 'test/CartPoleDynamics.m');
sys.fxu = jacobian(sys.f, [x;u]);
% matlabFunction(sys.fxu, 'File', 'test/CartPoleDynamicsJacobian.m');
sys.fxu_func = @(x, u) CartPoleDynamicsJacobian(x, u);
sys.x = x;
sys.u = u;
